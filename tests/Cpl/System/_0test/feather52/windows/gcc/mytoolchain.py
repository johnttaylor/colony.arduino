...
def create():
    tc = ToolChain( FINAL_OUTPUT_NAME, prjdir, build_variants, ARDUINO_TOOLS, ARDUINO_SUPPORT, ARDUINO_COMPILER_VER, ARDUINO_BSP_VER, ARDUINO_NRF_UTIL_VER, "arduino", env_error, override_freertos_config=True )
    return tc 
