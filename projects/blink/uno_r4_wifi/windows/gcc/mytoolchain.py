...
from nqbplib.toolchains.windows.arm_m4_arduino.renesas_uno_r4_wifi import ToolChain


# Function that instantiates an instance of the toolchain
def create():
    tc = ToolChain( FINAL_OUTPUT_NAME, prjdir, build_variants, ARDUINO_ROOT, ARDUINO_BSP_VER, "arduino", env_error )
    return tc 
