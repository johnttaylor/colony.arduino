#ifndef Bsp_uno_r4_wifi_Api_h_
#define Bsp_uno_r4_wifi_Api_h_
/*-----------------------------------------------------------------------------
...
/// Generic API
#define Bsp_Api_enableIrqs_MAP() __enable_irq()

/// Generic API
#define Bsp_Api_pushAndDisableIrqs_MAP() __disable_irq()  // FIXME: This really needs to PUSH the IRQ state!!!

/// Generic API
#define Bsp_Api_popIrqs_MAP() __enable_irq()  // FIXME: This really needs to POP the IRQ state!!!!
