...
class ToolChain( base.ToolChain ):
    ...
    def __init__( self, exename, prjdir, build_variants, arduino_root, env_bsp_ver, default_variant='arduino', env_error=None, override_freertos_config=False ):
        ...
        self._base_release.inc = self._base_release.inc + \
                ...
                r' -iwithprefix\variants\UNOWIFIR4\includes\ra\fsp\src\r_sce\crypto_procedures\src\sce5\plainkey\primitive' + \
        ...
        asm_and_compile_flags           = ' -D_RA_CORE=CM4 -D_RENESAS_RA_ -DARDUINO=10607 -DARDUINO_UNOWIFIR4 -DARDUINO_ARCH_RENESAS_UNO -DARDUINO_ARCH_RENESAS -DARDUINO_FSP -D_XOPEN_SOURCE=700 -DCFG_TUSB_MCU=OPT_MCU_RAXXX '
        cpp_and_c_flags                 = ' -ffunction-sections -fdata-sections -fmessage-length=0' # -fsigned-char -fno-builtin
        self._base_release.cflags       = self._base_release.cflags + common_flags + cpp_and_c_flags + asm_and_compile_flags
        self._base_release.c_only_flags = self._base_release.c_only_flags + ' -std=gnu17'
        self._base_release.cppflags     = self._base_release.cppflags + ' -std=gnu++17 -fno-threadsafe-statics -fno-rtti -fno-exceptions "-DARDUINO_BSP_VERSION=\\"' + env_bsp_ver + '\\""'
        ...
        core_libs                    = f'-Wl,--whole-archive -Wl,--start-group {uno_src_path}\\variants\\UNOWIFIR4\\libs\\libfsp.a {uno_src_path}\\cores\\arduino\\core.a -Wl,--end-group -Wl,--no-whole-archive'
